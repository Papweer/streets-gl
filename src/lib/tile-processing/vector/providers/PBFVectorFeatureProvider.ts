...
const PBFTagTypesMap: TagTypesMap = {
	...
	markings: TagTypes.Bool,
	hasArea: TagTypes.Bool,
	...
	barrierType: TagTypes.String,
	treeType: TagTypes.String,
	...
	railwayCategory: TagTypes.String,
